...
define('SPEEDYCACHE_VERSION', '1.0.4');
...
add_action('plugin_loaded', 'speedycache_load_plugin');
...
function speedycache_load_plugin(){
	...
	$speedycache->options = empty(get_option('speedycache_options')) ? array() : get_option('speedycache_options');
